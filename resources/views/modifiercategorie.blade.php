          ...
          <div class="row">
            <div class="col-xl-4 col-lg-5 col-md-7 d-flex flex-column mx-lg-0 mx-auto">
              <div class="card card-plain">
                ...
                <div class="card-body">
                  <form role="form" method="post" action="{{ url('/modifier-categories/' . $categorie->id_categorie) }}">
                  @csrf
                  @method('put')

                  <div class="mb-3">
                      <input type="text" class="form-control form-control-lg" placeholder="Nom" aria-label="nom" name="nom" value="{{ $categorie->nom }}">
                  </div>
