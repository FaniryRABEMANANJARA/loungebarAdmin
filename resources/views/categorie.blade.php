...
<td class="align-middle text-center">
                    ...
                    <a class="btn btn-link text-dark px-3 mb-0" href="{{ route('modificationCategorie', ['id' => $cat->id_categorie]) }}"><i class="fas fa-pencil-alt text-dark me-2" aria-hidden="true"></i>Modifier</a>
